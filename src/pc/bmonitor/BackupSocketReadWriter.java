...
public class BackupSocketReadWriter {
	...
	BackupSocketReadWriter(OutputStream os, InputStream is){
		oStream = os;
		iStream = is;
	...
	private BackupSocketReadWriter print(String s) throws IOException{
